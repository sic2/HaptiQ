...
{
    /// <summary>
    /// This class is identical to HapticLine, but it shows that HapticShape (and other classes)
    /// can be extended easily. 
    /// </summary>
    public class CustomShape : HapticShape
    {
        ...
        /// <param name="v"></param>
        /// <param name="w"></param>
        public CustomShape(System.Windows.Point v, System.Windows.Point w)
        {
