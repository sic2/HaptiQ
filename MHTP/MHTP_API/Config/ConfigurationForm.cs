...
namespace MHTP_API
{
    public partial class ConfigurationForm : Form
    {
        ...
        {
            Helper.Logger("MHTP_API.ConfigurationForm.ConfigurationForm::Configuration Form started");
            InitializeComponent();
            this.TopMost = true;
        ...
        private void saveForm()
        {
            ...
            configuration.mhtpName = configurationName.Text;
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            MHTPsManager.Instance.startConfigurationForm(); 
        } 
        ...
        private void acquireInputIdentifierClick(object sender, EventArgs e)
        {
            ...
            switch (typeItem)
            {
                ...
                case InputIdentifier.TYPE.glyph:
                    ...
                    break;
                default:
                    Helper.Logger("MHTP_API.ConfigurationForm.acquireInputIdentifierClick:: input type unknown " + typeItem);
                    break;
            }
            if (_input != null)
            {
