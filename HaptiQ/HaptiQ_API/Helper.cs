    ...
    public class Helper
    {
        ...
        public static void Logger(String str)
        {
            lock (_logLock)
            {
                ...
                String fileName = "Log-HaptiQ_API_" + DateTime.Now.ToString("yyyyMMdd") + ".txt";
                ...
                catch(IOException e)
                {
                    ...
                    Console.WriteLine("HaptiQ_API.Helper.Logger:: Impossible to write Log message " + str + " to file. " + e.Message);
                    throw new IOException("HaptiQ_API.Helper.Logger:: Impossible to write Log message " + str + " to file. " + e.Message);
                }
                finally
                {
                    if (file != null)
