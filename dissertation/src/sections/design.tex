...
\begin{figure}[H]
        ...
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
          %(or a blank line to force the subfigure onto a new line)
        \begin{subfigure}[H]{0.2\textwidth}
                \includegraphics[width=\textwidth]{glyph.jpg}
                \caption{Glyph}
                \label{fig:glyph}
        \end{subfigure}
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
...
\begin{figure}[H]
        ...
        \end{subfigure}
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
        \caption{Edge tacton patterns}\label{fig:edges}
\end{figure}
...
\begin{figure}[H]
        ...
        \end{subfigure}
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc.
        \caption{Corner tacton patterns}\label{fig:corners}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Pulsation tacton patterns}
  \label{fig:pulsation}
\end{figure}
